...
{
    public class CancelJustLayBetsAndStopAllStrategies: TelegramCommand
    {
        public override string Name { get;set; } = ReservedStrings.CancelJustLayBetsAndStopAllStrategies;
