...
{
    class UnmatchedBets: TelegramCommand
    {
        public UnmatchedBets(string strategyName):base(strategyName,strategyName){}
        public override string Name { get; set; } = ReservedStrings.UnmatchedBets;
