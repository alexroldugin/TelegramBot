...
{
    class Statistics: TelegramCommand
    {
        public Statistics(string strategyName):base(strategyName,strategyName){}
        public override string Name { get; set; } = ReservedStrings.Statistics;
