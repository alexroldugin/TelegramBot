...
{
    class JustStopStrategy: TelegramCommand
    {
        public JustStopStrategy(string strategyName):base(strategyName,strategyName){}
        public override string Name { get; set; } = ReservedStrings.JustStopStrategy;
